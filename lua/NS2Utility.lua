...
function TraceToExtents(origin, target,filter)
	...
	local targets = {
						Vector(tgtCenter.x+0,tgtCenter.y+0,tgtCenter.z+0), //model center
						Vector(tgtCenter.x+0,tgtCenter.y+0,tgtCenter.z+extents.z), //model top
						Vector(tgtCenter.x+0,tgtCenter.y+0,tgtCenter.z-extents.z), //model bottom
						Vector(tgtCenter.x+0,tgtCenter.y-extents.y,tgtCenter.z+0), //model left
						Vector(tgtCenter.x+0,tgtCenter.y+extents.y,tgtCenter.z+0), //model right
						Vector(tgtCenter.x+extents.x,tgtCenter.y+0,tgtCenter.z+0), //model front
						Vector(tgtCenter.x-extents.x,tgtCenter.y+0,tgtCenter.z+0) //model back
					}
	...
	for index, targetPoint in ipairs(targets) do
		...
		if (trace.fraction < 1) then
			...
			if trace.entity and trace.entity == target and trace.entity.TakeDamage then
				...
				if distanceFromTarget <= bestDistance then
					bestTrace = trace
				end	
			end
		end
