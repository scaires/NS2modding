...
function Marine:SetViewAngles(viewAngles, playerInput)

    Player.SetViewAngles(self, viewAngles, playerInput)

    // If we're spawning in or not moving angles due to player input,
    // don't swing weapon around accordingly
